...
np.save('/data/oceanparcels/output_data/data_Reint/'+region+'_oscillations', oscillations)
np.save('/data/oceanparcels/output_data/data_Reint/'+region+'_oscillation_stats', osc_stats)
